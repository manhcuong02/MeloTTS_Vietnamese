...
class Text2PhonemeSequence:
    ...
    def infer_dataset(
        self, input_file="", seperate_syllabel_token="_", output_file="", batch_size=64
    ):
        f = open(input_file, "r")
...
if __name__ == "__main__":
    a = Text2PhonemeSequence(
        pretrained_g2p_model="charsiu/g2p_multilingual_byT5_tiny_16_layers_100",
        language="vie-n",
        device='cpu',
    )
    print(
